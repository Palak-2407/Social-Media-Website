...
const mongooseURI = 'mongodb://127.0.0.1:27017/socialMediaApp';
...
//     try{
//         const post = await Post.findByIdAndUpdate(req.param.postId,req.body)
//         res.status(200).json(post);
//     }
//     catch(error){
//         res.sendStatus(500).send('Error updating post');
//     }
// });
...
//react basics-- stste, prpps , how to create react, create comp-fuction, class